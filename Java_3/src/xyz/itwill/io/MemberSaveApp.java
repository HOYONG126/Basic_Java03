...
public class MemberSaveApp {
	public static void main(String[] args) throws IOException {
		...
		//NotSerializableException : 객체 직렬화 처리되지않은 클래스의 객체를 출력스트림으로
		//전달할경우 발생되는 예외
		// => 출력스트림으로 전달될 객체의 클래스를 객체 직력화 처리하면 예외 미발생
		
		out.writeObject(new Member("abc123", "홍길동", "010-3174-1234"));
		out.writeObject(new Member("def456", "임꺽정", "010-3555-5678"));
		out.writeObject(new Member("ghi789", "장길산", "010-3451-9012"));
		out.close();
